...
class MFRC522:
  ...
  def MFRC522_ToCard(self,command,sendData):
    ...
    while True:
      ...
      irqResponses.add(format(n, 'x'))
      i = i - 1
      if ~((i!=0) and ~(n&0x01) and ~(n&waitIRq)):
        break
    print("IRQ Responses: ", irqResponses)
    print(i)

    self.ClearBitMask(self.BitFramingReg, 0x80)

    if i != 0:
      print("i is not 0! i =", i)
      if (self.Read_MFRC522(self.ErrorReg) & 0x1B)==0x00:
        ...
        if command == self.PCD_TRANSCEIVE:
          ...
          if n == 0:
            n = 1
          if n > self.MAX_LEN:
            print("Truncating n: originally", n)
            n = self.MAX_LEN
          ...
          while i<n:
            ...
            print(backData[-1], end=" ")
            i = i + 1;
          print()
      else:
        print(format(self.Read_MFRC522(self.ErrorReg), "b"))
        status = self.MI_ERR
    else:
      print("i = 0")
  ...
  def MFRC522_Request(self, reqMode):
    ...
    print(status,backData,backBits)
